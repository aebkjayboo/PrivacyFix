...
/** 1.21.11: GuiGraphics render pipeline. Custom drawing happens between the background and the widgets. */
public abstract class CompatScreen extends Screen {
    ...
    public void renderBackground(GuiGraphics g, int mouseX, int mouseY, float partialTick) {
        ...
        paint(new Painter() {
            ...
            @Override public void text(String s, int x, int y, int argb) { g.drawString(font, s, x, y, argb); }
